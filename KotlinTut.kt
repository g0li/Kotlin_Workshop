...
fun main(args : Array<String>) {
    ...
    */
    ...
    var myArray = arrayOf(1, 1.23, "Shrey")
    ...
    println("Doug in Array : ${myArray.contains("Shrey")}")
    ...
    // Get index of value
    println("Shrey Index : ${str1.indexOf("Shrey")}")
    ...
    val map2 = mutableMapOf(1 to "Aashay", 2 to 25)
    ...
    val spot = Dog("Daisy", 20.0, 14.5, "Ziyad Bhombal")
